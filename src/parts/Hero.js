...
import ImageHero from 'assets/images/image-01.jpg'
import ImageHero_ from 'assets/images/image-01-frame.jpg'
        ...
        <div className="row align-items-center">
          ...
          <div className="row" style={{marginTop: 80}}>
            <div className="col-auto" style={{marginRight : 30}}>
              <img width="36" height="36" src="/images/icons/ic_traveler.svg" alt={`${props.data.travelers} Travelers`}/>
              <h6 className="mt-3">
            ...
            <div className="col-auto" style={{marginRight : 30}}>
              <img width="36" height="36" src="/images/icons/ic_treasure.svg" alt={`${props.data.treasures} Treasures`}/>
              <h6 className="mt-3">
